...
bag = rosbag.Bag('Data/elevation_map.bag')
...
if last_msg_data is not None:
    ...
    # img.save("elevation_data_linear.bmp")

    # Plotting the filled elevation data
    fig = plt.figure(figsize=(12, 8))
    ax = fig.add_subplot(111, projection='3d')
    ax.plot_surface(x, y, elevation_data_filled, cmap='gray', alpha=1)
    ax.plot_wireframe(x, y, elevation_data_filled, color='gray', linewidth=0.05)
